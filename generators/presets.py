...
CURATED_PRESETS = {
    ...
    "17": Preset(
        label="Endapan Waktu",
        description="Sedimen hitam-putih -- lapisan menumpuk & tererosi, kedalaman lewat sejarah.",
        technique="sedimen",
        palette_mode="hitam_putih",
        palette_name=None,
    ),
    "18": Preset(
        label="Ruang Hampa",
        description="Kekosongan dengan nuansa slate gelap -- tegangan antara penuh dan tiada.",
        technique="kekosongan",
        palette_mode="palette",
        palette_name="monochrome_slate",
    ),
    "19": Preset(
        label="Penampang Retak",
        description="Patahan dengan warna acak -- diskontinuitas geologis, selalu unik.",
        technique="patahan",
        palette_mode="acak_harmonis",
        palette_name=None,
    ),
    "20": Preset(
        label="Sidik Jari Alam",
        description="Kontur Alir hitam-putih -- garis tipis rapat mengalir bak paisley/fingerprint.",
        technique="kontur_alir",
        palette_mode="hitam_putih",
        palette_name=None,
    ),
    "21": Preset(
        label="Titik Halftone",
        description="Nirmana Titik hitam-putih -- grid dot bergradasi ukuran, gaya cetak halftone.",
        technique="titik",
        palette_mode="hitam_putih",
        palette_name=None,
    ),
